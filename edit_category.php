...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(mysqli_query($conn, $sql)) {
        header("Location: categories.php?message=تم تحديث الفئة بنجاح");
        exit();
    } else {
        header("Location: categories.php?error=حدث خطأ أثناء تحديث الفئة");
        exit();
    }
}
?>
...
<head>
    ...
    <title>تعديل الفئة - نظام إدارة المخزون المبسط</title>
...
<body>
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-edit"></i> تعديل الفئة</h1>
            <a href="categories.php" class="btn" style="background: #6c757d; color: white;"><i class="fas fa-arrow-right"></i> رجوع</a>
        </div>
        ...
        <div class="form-container">
            <form action="edit_category.php?id=<?php echo $id; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <a href="categories.php" class="btn" style="background: #6c757d; color: white;"><i class="fas fa-times"></i> إلغاء</a>
                </div>
            </form>
        </div>
    </div>
