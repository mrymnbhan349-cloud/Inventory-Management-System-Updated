...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name)){
        header("Location: edit_customer.php?id=$id&error=اسم العميل مطلوب");
        exit();
    }
    ...
    if(mysqli_query($conn, $sql)) {
        header("Location: customers.php?message=تم تحديث بيانات العميل بنجاح");
        exit();
    } else {
        header("Location: customers.php?error=حدث خطأ أثناء تحديث بيانات العميل");
        exit();
    }
}
?>
...
<head>
    ...
    <title>تعديل العميل - نظام إدارة المخزون المبسط</title>
...
<body>
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-edit"></i> تعديل بيانات العميل</h1>
            <a href="customers.php" class="btn" style="background: #6c757d; color: white;"><i class="fas fa-arrow-right"></i> رجوع</a>
        </div>
        ...
        <div class="form-container">
            <form action="edit_customer.php?id=<?php echo $id; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="notes" name="notes" value="<?php echo htmlspecialchars($customer['notes']); ?>">
                </div>
                <div class="form-group">
